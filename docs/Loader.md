# OpenDMA Document Loaders

An OpenDMA Document Loader fetches content and metadata from an ECM system
through OpenDMA and converts the data into LangChain `Document` objects.
